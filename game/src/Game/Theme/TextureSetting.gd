...
@export var texture_margin_left: float = 0:
	get:
		return texture_margin_left
	set(v):
		texture_margin_left = v
		emit_changed()
@export var texture_margin_top: float = 0:
	get:
		return texture_margin_top
	set(v):
		texture_margin_top = v
		emit_changed()
@export var texture_margin_right: float = 0:
	get:
		return texture_margin_right
	set(v):
		texture_margin_right = v
		emit_changed()
@export var texture_margin_bottom: float = 0:
	get:
...
@export var expand_margin_left: float = 0:
	get:
		return expand_margin_left
	set(v):
		expand_margin_left = v
		emit_changed()
@export var expand_margin_top: float = 0:
	get:
		return expand_margin_top
	set(v):
		expand_margin_top = v
		emit_changed()
@export var expand_margin_right: float = 0:
	get:
		return expand_margin_right
	set(v):
		expand_margin_right = v
		emit_changed()
@export var expand_margin_bottom: float = 0:
	get:
...
@export var content_margin_left: float = -1:
	get:
		return content_margin_left
	set(v):
		content_margin_left = v
		emit_changed()
@export var content_margin_top: float = -1:
	get:
		return content_margin_top
	set(v):
		content_margin_top = v
		emit_changed()
@export var content_margin_right: float = -1:
	get:
		return content_margin_right
	set(v):
		content_margin_right = v
		emit_changed()
@export var content_margin_bottom: float = -1:
	get:
