...
void ScoreOverview::on_gamestate_updated() {
	...
	rank_label.set_text_via_to_string(country.get_total_rank());
	rank_label.set_tooltip_string(country_name_rank_tooltip);

	prestige_rank_label.set_text_via_to_string(country.get_prestige_rank());
	...
	industrial_rank_label.set_text_via_to_string(country.get_industrial_rank());
	...
	military_rank_label.set_text_via_to_string(country.get_military_rank());
