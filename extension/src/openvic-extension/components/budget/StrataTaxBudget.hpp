...
namespace OpenVic {
	...
	private:
		...
		fixed_point_t calculate_budget_and_update_custom(CountryInstance& country, const fixed_point_t scaled_value) override;
		...
		void update_slider_tooltip(CountryInstance& country, const fixed_point_t scaled_value) override;

	public:
		StrataTaxBudget(GUINode const& parent, Strata const& new_strata, ModifierEffectCache const& new_modifier_effect_cache);
