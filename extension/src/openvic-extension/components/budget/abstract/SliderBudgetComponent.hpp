...
namespace OpenVic {
	...
	enum BudgetType { BALANCE, EXPENSES };
	...
	protected:
		...
		SliderBudgetComponent(
			...
			godot::NodePath const& slider_path, godot::NodePath const& budget_label_path = {},
		...
		virtual void update_slider_tooltip(CountryInstance& country, const fixed_point_t scaled_value);
