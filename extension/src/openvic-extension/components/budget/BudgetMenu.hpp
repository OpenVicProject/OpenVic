...
namespace OpenVic {
	...
	private:
		...
		CountryInstance* country_ptr { nullptr };
	...
	public:
		BudgetMenu(GUINode const& parent, utility::forwardable_span<Strata> strata_keys);
		void set_country(CountryInstance& new_country);
		void update();
	};
}