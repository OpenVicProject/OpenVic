...
void BudgetMenu::update_projected_balance() {
	...
	fixed_point_t projected_balance = country.get_gold_income_untracked() + administration_budget.get_balance() +
	                                  diplomatic_budget.get_balance() + education_budget.get_balance() +
	                                  military_budget.get_balance() + national_stockpile_budget.get_balance() +
	                                  social_budget.get_balance() + tariff_budget.get_balance();
...
void BudgetMenu::update_projected_expenses() {
	...
	const fixed_point_t projected_expenses = administration_budget.get_expenses() + diplomatic_budget.get_expenses() +
	                                         education_budget.get_expenses() + military_budget.get_expenses() +
	                                         national_stockpile_budget.get_expenses() + social_budget.get_expenses() +
