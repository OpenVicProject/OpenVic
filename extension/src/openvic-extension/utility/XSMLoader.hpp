...
static bool read_xsm_metadata(Ref<FileAccess> const& file, xsm_metadata_t& metadata, int32_t version) {
	bool res = true;
	if (version != 1) {
...
static bool read_rot_keys(Ref<FileAccess> const& file, std::vector<rotation_key_t>* keys_out, int32_t count, int32_t version) {
	bool res = true;
...
static bool read_skeletal_submotion(Ref<FileAccess> const& file, skeletal_submotion_t& submotion, int32_t version) {
	bool res = true;
...
static bool read_xsm_bone_animation(Ref<FileAccess> const& file, bone_animation_t& bone_animation, int32_t version) {
...
static bool read_node_submotion(Ref<FileAccess> const& file, std::vector<node_submotion_t>* submotions) {
	bool res = true;
