...
namespace OpenVic {
	...
	private:
		...
		ArgumentOption(
		    godot::StringName const& name,
		    godot::Variant const& default_value,
		    godot::String const& description,
		    godot::PackedStringArray const& aliases,
		    godot::String const& option_args,
	...
	public:
		...
		static godot::Ref<ArgumentOption> create(
		    ...
		    godot::PackedStringArray const& p_aliases = {},
		    godot::String const& p_option_args = godot::String(),
	...
	class ArgumentParser : public godot::Object {
		...
		godot::Variant _parse_value(
		    godot::StringName const& p_arg_name, godot::String const& p_value_string, godot::Ref<ArgumentOption>& p_option
		);
