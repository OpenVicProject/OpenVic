...
void MapMesh::_bind_methods() {
	...
	ADD_PROPERTY(
	    PropertyInfo(Variant::FLOAT, "repeat_proportion", PROPERTY_HINT_NONE, "suffix:m"),
	    "set_repeat_proportion",
	    "get_repeat_proportion"
	);
	ADD_PROPERTY(
	    PropertyInfo(Variant::INT, "subdivide_width", PROPERTY_HINT_RANGE, "0,100,1,or_greater"),
	    "set_subdivide_width",
	    "get_subdivide_width"
	);
	ADD_PROPERTY(
	    PropertyInfo(Variant::INT, "subdivide_depth", PROPERTY_HINT_RANGE, "0,100,1,or_greater"),
	    "set_subdivide_depth",
	    "get_subdivide_depth"
	);
}
