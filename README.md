...
## Required
* [Godot 4 RC 5](https://downloads.tuxfamily.org/godotengine/4.0/rc5/)
* [scons](https://scons.org/)

## [Godot Documentation](https://docs.godotengine.org/en/latest/)

## Build/Run Instructions
1. Install [Godot 4 RC 5](https://downloads.tuxfamily.org/godotengine/4.0/rc5/) and [scons](https://scons.org/) for your system.
2. Run the command `git submodule update --init --recursive` to retrieve all related submodules.
3. Run `scons` in the project root, you should see a libopenvic2 file in `game/bin/openvic2`.
4. Open with Godot 4 RC 5, click import and navigate to the `game` directory.
5. Import and edit.
...
2. Open `game/project.godot` with Godot 4 RC 5.
